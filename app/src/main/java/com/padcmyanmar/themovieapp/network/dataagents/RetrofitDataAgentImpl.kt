...
//import com.padcmyanmar.themovieapp.network.responses.GetActorsResponse
//import com.padcmyanmar.themovieapp.network.responses.GetCreditsByMovieResponse
//import com.padcmyanmar.themovieapp.network.responses.GetGenresResponse
...
//                ) {
//                    if (response.isSuccessful) {
//                        response.body()?.let { creditsByMovieResponse ->
//                            onSuccess(Pair(creditsByMovieResponse.cast ?: listOf(), creditsByMovieResponse.crew ?: listOf()))
//                        }
//                    } else {
//                        onFailure(response.message())
//                    }
